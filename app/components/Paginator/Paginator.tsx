export function Paginator({ previous, next, pageChange }) {
  return (
    <div className="flex justify-center space-x-5 mt-5">
      {previous && (
        <div className="group link flex items-center float-left" onClick={() => pageChange(previous)}>
      ...
      {next && (
        <div className="group link flex items-center float-right" onClick={() => pageChange(next)}>
...
export function SmallPaginator({ previous, next, pageChange }) {
  return (
    <div className="flex justify-center space-x-5 font-normal">
      {previous && (
        <div className="link font-medium group flex items-center float-left" onClick={() => pageChange(previous)}>
      ...
      {next && (
        <div className="link font-medium group flex items-center float-right" onClick={() => pageChange(next)}>
